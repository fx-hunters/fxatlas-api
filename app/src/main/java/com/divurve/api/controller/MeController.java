...
public class MeController {
    ...
    public ApiResponse<ProfileResponse> getProfile(@CurrentUser UUID userId) {
        ProfileView profile = userProfileService.getProfile(userId);
    ...
    public ApiResponse<ProfileResponse> updateProfile(
        ...
        ProfileView profile = userProfileService.updateProfile(userId, request.name());
        return ApiResponse.of(toProfileResponse(profile));
    }
    ...
    public ApiResponse<RiskProfileResponse> updateRiskProfile(
            @CurrentUser UUID userId,
            @RequestBody RiskProfileUpdateRequest request) {
        List<RiskProfileService.AnswerCommand> answers = request.answers() == null
                ...
                : request.answers().stream()
                        ...
                        .toList();
        return ApiResponse.of(toRiskProfileResponse(riskProfileService.reassess(userId, answers)));
    }
    ...
    public ApiResponse<SettingsResponse> updateSettings(
        ...
        SettingsView view = userSettingsService.updateSettings(
                userId, request.defaultBankCode(), request.fxDiscountRatio(),
